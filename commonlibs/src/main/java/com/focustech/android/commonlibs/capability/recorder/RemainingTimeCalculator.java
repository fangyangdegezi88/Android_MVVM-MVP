...
public class RemainingTimeCalculator {
    ...
    /**
     * If called, the calculator will return the minimum of three estimates: how
    ...
    public long timeRemaining() {
        ...
        if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.JELLY_BEAN_MR2) {
            blocks = fs.getAvailableBlocksLong() - EXTERNAL_STORAGE_BLOCK_THREADHOLD;
    ...
    public boolean diskSpaceAvailable() {
        ...
        // keep one free block
        if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.JELLY_BEAN_MR2) {
            return fs.getAvailableBlocksLong() > EXTERNAL_STORAGE_BLOCK_THREADHOLD;
        } else {
