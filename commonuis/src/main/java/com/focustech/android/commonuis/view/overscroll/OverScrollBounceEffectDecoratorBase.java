...
import com.focustech.android.commonuis.view.overscroll.adapters.IOverScrollDecoratorAdapter;
...
public abstract class OverScrollBounceEffectDecoratorBase implements View.OnTouchListener {
    ...
    private final String TAG=OverScrollBounceEffectDecoratorBase.class.getSimpleName();
    ...
    protected class IdleState implements IDecoratorState {
        ...
        public boolean handleMoveTouchEvent(MotionEvent event) {
            ...
            if ((mViewAdapter.isInAbsoluteStart() && mMoveAttr.mDir) ||
                ...
                if(mViewAdapter.getView() instanceof ViewPager){
                }
    ...
    protected class OverScrollingState implements IDecoratorState {
        ...
        public boolean handleMoveTouchEvent(MotionEvent event) {
            ...
            Log.d(TAG,"OverScrollingState--->handleMoveTouchEvent");
            ...
            Log.d("handleMoveTouchEvent","deltaOffset="+deltaOffset+" newOffset="+newOffset);
