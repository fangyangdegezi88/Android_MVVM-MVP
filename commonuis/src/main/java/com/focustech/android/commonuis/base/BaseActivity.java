 ...
 */
@Deprecated
public abstract class BaseActivity<V extends BaseCommonPresenter> extends AppCompatActivity
        implements CreateInit, PublishActivityCallBack, SFActionBar.SFActionBarListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (checkHasLoading(this)) {
            ...
            initViews(this, null, savedInstanceState);
