...
import com.focustech.android.commonuis.view.overscroll.adapters.AbsListViewOverScrollDecorAdapter;
import com.focustech.android.commonuis.view.overscroll.adapters.HorizontalScrollViewOverScrollDecorAdapter;
import com.focustech.android.commonuis.view.overscroll.adapters.RecyclerViewOverScrollDecorAdapter;
import com.focustech.android.commonuis.view.overscroll.adapters.ScrollViewOverScrollDecorAdapter;
import com.focustech.android.commonuis.view.overscroll.adapters.StaticOverScrollDecorAdapter;
import com.focustech.android.commonuis.view.overscroll.adapters.ViewLeftOverScrollDecorAdapter;
import com.focustech.android.commonuis.view.overscroll.adapters.ViewPagerOverScrollDecorAdapter;
import com.focustech.android.commonuis.view.overscroll.adapters.ViewRightOverScrollDecorAdapter;
...
public class OverScrollDecoratorHelper {
    ...
    public static void setUpOverScroll(ViewPagerFixed viewPager) {
        new HorizontalOverScrollBounceEffectDecorator(new ViewPagerOverScrollDecorAdapter(viewPager));
    }


    public static void setUpOverLeftScroll(View view){
        new HorizontalOverScrollBounceEffectDecorator(new ViewLeftOverScrollDecorAdapter(view));
    }

    public static void setUpOverRightScroll(View view){
        new HorizontalOverScrollBounceEffectDecorator(new ViewRightOverScrollDecorAdapter(view));
    }
